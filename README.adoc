...
image::https://github.com/fahmidur/sfr-lisp-r1/actions/workflows/test.yml/badge.svg[TestBadge, link="https://github.com/fahmidur/sfr-lisp-r1/actions/workflows/test.yml"]
...
Alternatively, 
if you already cloned the repo without this flag,
...
* Ruby Installation -- for building and running tests
** Ruby >= v3.4.1 
** Rake >= v13.2.1 (Comes with most Ruby installations)
** Bundler >= v2.4.6 (Comes with most Ruby installations)
...
Most modern Ruby installations come with Bundler. 
If it is not present, please run:
```
gem install bundler
```

Most modern Ruby installations come with Rake.
If it is not present, please run:
```
gem install rake
```
...
* https://fahmidur.com/nodes/p/sfrlisp-1[Blog Post on fahmidur.com]
* https://sfrlisp1.fahmidur.com/[Hosted WASM Build on fahmidur.com]
